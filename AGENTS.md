...
- For wheel alignment, read `AGENT_TRAINING_HANDOFF.md`, `WANDB_LOGGING.md` and `ALIGN_MOTION_V2.md`. Cite the hardware source when making hardware claims; distinguish the user's confirmed facts from legacy comments and hypotheses.
