...
- For wheel alignment, read `AGENT_TRAINING_HANDOFF.md`, `WANDB_LOGGING.md` and `ALIGN_MOTION_V5.md`. `ALIGN_MOTION_V2.md` is historical context. Cite the hardware source when making hardware claims; distinguish the user's confirmed facts from legacy comments and hypotheses.
