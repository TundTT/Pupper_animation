...
// geometry or its wheel PID. All motion here comes from the inverted plan.
class InvertedTriangleController : public KeyframeController {
 public:
 ...
 protected:
  inverted_triangle::Controller triangle_;
