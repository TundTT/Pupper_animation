...
class NotebookLiftController:public NeuralController {
 ...
 protected:
 notebook_alignment_v4::LiftAlignCore lift_;
 ...
 rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr status_pub_,motor_pub_,alignment_pub_;
 std::shared_ptr<realtime_tools::RealtimePublisher<std_msgs::msg::Float64MultiArray>> rt_status_,rt_motors_,rt_alignment_;
