"""X roll, Triangle walk, Circle wheels. Startup homes hardware; confirm pose first."""
...
def generate_launch_description():
    ...
    nodes = [
        ...
        Node(package='controller_manager', executable='ros2_control_node', parameters=[config, roll, combined], output='both'),
